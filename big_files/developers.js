(function($){
	...
	timmm.to($('.mainLogo'), .7, {lineHeight: 100, height:100, width:300, backgroundColor:"rgba(0,0,0,1)", ease:Expo.easeInOut}, 0);
	timmm.to($('.mainLogo img'), .7, {width:250, height:52, paddingTop:15, ease:Expo.easeInOut, force3D:true}, 0);
